        ...
        <div className="row justify-content-center">
          <h4 className="text-center py-3 text-decoration-underline">My cart</h4>
            ...
            <div className="d-flex justify-content-center  py-3">
             <p className="position-relative fw-bolder text-title ">Cart <span className=" position-absolute translate-middle rounded-pill badge bg-danger mx-2">{totalUniqueItems}</span></p>
             <p className="fw-bolder text-title  ms-5">Total Items<span className=" position-absolute translate-middle rounded-pill badge bg-success mx-2">{totalItems}</span></p>
            </div>
            ...
            <div className="d-flex justify-content-between py-5">
              <nutton onClick={() => emptyCart()}  className="btn btn-outline-danger">Clear All</nutton>
